// ESLint v9 flat config for the Lahijan marketing website SPA.
//
// Mirrors web/eslint.config.js: typescript-eslint strict + react +
// react-hooks + react-refresh + prettier integration + the local
// @lahijan/i18n plugin (no hardcoded strings; no physical layout utilities)
// required by ADR-0017 + docs/architecture/conventions.md.
...
export default tseslint.config(
  {
    ignores: ["dist/**", "node_modules/**", "coverage/**", ".vite/**", "eslint-plugins/**"],
  },
  ...
  // under src/ (where the tsconfig's projectService knows about files).
  {
    ...
    rules: {
      ...
      "@typescript-eslint/no-misused-promises": [
        ...
        // onClick, etc.). React tolerates these fine.
