...
| [WS-16](./WS-16-storage-module.md) | Object Storage Module | done | WS-13, WS-08 |
| [WS-17](./WS-17-billing-metering.md) | Billing & Metering | done | WS-08, WS-09 |
...
| [WS-19](./WS-19-marketing-website.md) | Marketing Website | done | WS-18 |
...
| [WS-32](./WS-32-interactive-exec-console.md) | Interactive Exec Console (xterm.js + WebSocket) | done | WS-11, WS-14, WS-20 |
...
| [WS-26](./WS-26-multi-node-cluster.md) | Multi-Node / HA Control Plane | done | WS-23 |
