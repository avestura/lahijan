// Package billing: integration_test_main_test.go wires the testcontainers
// Postgres harness for the billing_test package. Every test in this
...
// in the billing_test package, then tears down + exits. Setup owns
